...
public class SendChangeEmailVerification {
    ...
    public void sendChangeEmailVerification(String recipientEmail, String token) {
        ...
        try {
            ...
            message.setSubject("Action Required: Please Verify Your New Email Address");

            // HTML email content
            String verificationLink = "http://maplehugs.ddns.net/new_changeemailverify.jsp?token=" + token;
            String htmlContent = "<!DOCTYPE html>"
                    ...
                    + "    <div class='content'>"
                    + "      <p>Dear User,</p>"
                    + "      <p>To complete your email change request, please verify your new email address by clicking the button below:</p>"
                    + "      <p><a href='" + verificationLink + "' class='verify-button'>Verify New Email</a></p>"
            ...
            System.out.println("Change email verification sent successfully!");
