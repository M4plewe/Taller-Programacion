    ...
    <script>
        ...
        function verifyEmail() {
            ...
            if (!token) {
                ...
                document.getElementById("message").innerText = "!ups! No tenemos una token para cambiar tu correo";
            } else {
                // Hacer una solicitud GET al servlet usando fetch
                fetch(`/verifyemailservicechange?token=` + token)
                    ...
                    .then(data => {
                        ...
                        if (data === "Invalid token") {
                            ...
                            if (data.includes("Email verified successfully")) {
                                document.getElementById("redirect-message").innerText = "Redirigiendo a la página de inicio de sesión en 5 segundos...";
                                setTimeout(function () {
